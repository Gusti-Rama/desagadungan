...
export const metadata: Metadata = {
  title: "Data Penduduk",
  description:
    "Data dan statistik penduduk Desa Gadungan — jumlah penduduk, RT/RW, luas wilayah, mata pencaharian, dan demografi warga.",
};

/**
 * Data Penduduk Page — Population data & statistics.
 *
 * All data here is placeholder — edit the values directly in this file or
 * in the Demographics component.
 */
      ...
      <section className="bg-gradient-to-br from-emerald-800 to-emerald-900 py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-2xl text-lg text-emerald-100/80">
            Statistik dan data demografi warga Desa Gadungan, Kecamatan Wedi,
