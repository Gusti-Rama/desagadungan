        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            <div className="flex items-center gap-3">
              <div className="relative flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-100">
                <Image
                  src="/logo.png"
                  alt="Logo Desa"
                  fill
          ...
          <div>
            ...
            <address className="mt-4 space-y-2 not-italic text-sm text-gray-600">
              ...
              <p>Jawa Tengah, Indonesia, 57461</p>
            </address>
          </div>
